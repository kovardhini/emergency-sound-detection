...
Loads a trained model and produces:
  ...
  - a confusion matrix image saved to models/confusion_matrix.png
...
def evaluate(model_path):
    data = get_datasets(augment_train=False)
    ...
    plt.ylabel("Actual")
    plt.title("Confusion Matrix — Emergency Sound Detection")
    plt.tight_layout()
